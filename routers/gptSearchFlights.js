      ...
      const result = {
        ...
        OutboundFlights: {
          DestinationAirport: {
            ...
            PersianName:
              ticket.OutboundFlights[0].DestinationAirport.PersianName,
            CityPersianName:
              ticket.OutboundFlights[0].DestinationAirport.CityPersianName,
          },
        ...
        InboundFlights: {
          DestinationAirport: {
            ...
            PersianName:
              ticket.InboundFlights[0]?.DestinationAirport.PersianName,
            CityPersianName:
              ticket.InboundFlights[0]?.DestinationAirport.CityPersianName,
            CountryCode:
              ticket.InboundFlights[0]?.DestinationAirport.CountryCode,
          },
